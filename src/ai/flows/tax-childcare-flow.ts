...
4.  **Final Output:** Once all fields are collected, you MUST return a single, valid markdown table and nothing else. Do not add any extra explanation or text outside of the table.
...
**Your next response:**
Based on the history, determine the next question to ask. If all data is collected, provide the final markdown table. Otherwise, ask the next required question.
